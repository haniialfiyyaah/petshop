 ...
 * @author AcePC
 */
public class FHistoryStok extends javax.swing.JFrame {

    /**
     * Creates new form FHistoryStok
     */
    koneksi dbsetting;
    ...
    private javax.swing.table.DefaultTableModel getDefaultTableModel(){
        return new javax.swing.table.DefaultTableModel(
                new Object[][][][][][]{},
                new String[] {"Kode Barang","Nama Barang","Tanggal","Harga Beli","Jumlah","Kasir"}
        ){
    ...
    private void settableload(){
        ...
        try{
            ...
            String SQL = "select * from tbhistorystok order by (tanggal)";
    ...
    private void initComponents() {
        ...
        b_tampil = new javax.swing.JButton();
        ...
        b_tampil.setBackground(new java.awt.Color(153, 153, 153));
        b_tampil.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        b_tampil.setText("TAMPIL SELURUH");
        b_tampil.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                b_tampilActionPerformed(evt);
            }
        });
        ...
        jLabel12.setText("History Stok Barang");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txt_cari, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {BHapus, BHapusSemua});
        ...
        setSize(new java.awt.Dimension(616, 398));
    ...
    private void BHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BHapusActionPerformed
        ...
        if(konfirmasi==JOptionPane.YES_OPTION)
        {
            try{
                ...
                Connection kon = DriverManager.getConnection(database, user, pass);
                Statement stt = kon.createStatement();
                String SQL = "Delete From `tbhistorystok`" 
                + "where "
                + "kode='"+tableModel.getValueAt(TabelData.getSelectedRow(), 0).toString()+"'";
    ...
    private void b_tampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_tampilActionPerformed
        // TODO add your handling code here:
        tableModel.setRowCount(0);
        settableload();
        txt_cari.setText("");
        txt_cari.requestFocus();
    }//GEN-LAST:event_b_tampilActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FHistoryStok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FHistoryStok().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton b_tampil;

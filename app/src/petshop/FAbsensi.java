...
public class FAbsensi extends javax.swing.JFrame {

    /**
     * Creates new form FAbsensi
     */
     koneksi dbsetting;
    ...
    private javax.swing.table.DefaultTableModel getDefaultTableModel(){
        return new javax.swing.table.DefaultTableModel(
                new Object[][][][][][]{},
                new String[] {"Nama","Jam","Tanggal","Ket"}
        ){
    ...
    private void settableload(){
        ...
        try{
            ...
            String SQL = "select nama,jam,tanggal,ket from tbabsen";
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(592, 391));
    ...
    private void BHapusSemuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BHapusSemuaActionPerformed
        ...
        if(konfirm==JOptionPane.YES_OPTION)
        {
            try{
                ...
                Connection kon = DriverManager.getConnection(database, user, pass);
                Statement stt = kon.createStatement();
                String SQL = "Delete From tbabsen ";
    ...
    private void BHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BHapusActionPerformed
        ...
        if(konfirmasi==JOptionPane.YES_OPTION)
        {
            try{
                ...
                Connection kon = DriverManager.getConnection(database, user, pass);
                Statement stt = kon.createStatement();
                String SQL = "Delete From tabsen"
                + "where "
                + "nama='"+tableModel.getValueAt(TabelData.getSelectedRow(), 0).toString()+"'";
                stt.executeUpdate(SQL);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FAbsensi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
